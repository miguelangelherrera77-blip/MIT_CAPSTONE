...
#
# Description: This script runs no-retrieval Wikipedia probes through an OpenRouter
#              chat model, captures prompts and responses, and appends evidence for
#              the Checkpoint 1.1 retrieval-necessity analysis.
#
#################################################################################
