...
WORKSPACE_DIR = FINAL_CAPSTONE_DIR.parent
OPENROUTER_BASE_URL = "https://openrouter.ai/api/v1"
LLM_MODEL = "openai/gpt-5.4-mini"
TEMPERATURE = 0.2
MAX_STEPS = 3
LOG_PATH = FINAL_CAPSTONE_DIR / "Ragas_Experiments" / "security_cost_demo.log"
...
def check_api_key() -> str:
    for env_path in (SCRIPT_DIR / ".env", FINAL_CAPSTONE_DIR / ".env", WORKSPACE_DIR / ".env"):
        if env_path.is_file():
